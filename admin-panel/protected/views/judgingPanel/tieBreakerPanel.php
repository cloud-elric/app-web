<div class="container">
	...
	<div class="row padding-vertical-30 padding-horizontal-50">
		...
		<div class="col-md-3 margin-vertical-10">
			...
			<?php echo CHtml::link("Resolve", array("judgingPanel/breakerRoundByCategory", "id"=>$categoria->id_category, 't'=>$t), array("class"=>"btn btn-raised btn-primary ladda-button", "data-style"=>"expand-left", "target"=>"_blank","data-plugin"=>"ladda"))?>
			</div>
		</div>	
		<?php } }?>
	</div>
