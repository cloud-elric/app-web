								...
								<td><table cellpadding="0" cellspacing="0"
										...
										<tbody>
											...
											<tr>
												...
												<br><?php //echo Yii::t('recoveryPassword', 'descriptionMessage1')?> <?= "Tu pago a ". $data['concurso']->txt_name." en el ".$data['ordenCompra']->txt_description." con el monto de $".$data['ordenCompra']->num_total." pesos"?> <a
								...
								<td style="padding: 0; border-collapse: collapse;"><table
										...
										<tbody>
											...
											<tr
												...
												<td width="128" align="right">© <?=date('Y')?> Global judging</td>
