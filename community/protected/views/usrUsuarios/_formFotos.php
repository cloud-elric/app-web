	...
	<div class="modal-dialog modal-center">
		...
		<div class="modal-content">
			...
			<div class="modal-footer">
                ...
                <button type="button" class="btn btn-green btn-small btn-borrar-foto" onClick="borrarImagen($(this), '<?=$concurso->txt_token?>');" data-value="<?=$pic->txt_pic_number?>"><?=Yii::t('formFotos', 'successBtnModal')?></button>
			</div>
			<!-- end / .modal-footer -->
